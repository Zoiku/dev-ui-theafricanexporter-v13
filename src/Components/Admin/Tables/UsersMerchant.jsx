...
const UsersMerchant = () => {
  ...
  const columns = [
    ...
    { field: "businessType", headerName: "Business Type", width: 130 },
    {
      ...
      headerName: "Status",
      width: 100,
      renderCell: ({ row }) => <IOSSwitch disabled checked={row.status} />,
    },
    {
      field: "isValidated",
      ...
      renderCell: ({ row }) => (
        <IOSSwitch
          disabled={
            state?.requestState.loading | row?.isValidated ? true : false
          }
          onChange={() => handleApproveMerchant()}
                ...
                {selectedUser?.company && (
                  <section>
                    ...
                    <div className="form-controller-input form-controller">
                      <TextField
                        disabled
                        value={selectedUser?.company?.introduction}
                        multiline
                        fullWidth
                        type="text"
                    ...
                    <div className="form-controller-input-duo form-controller">
                      <TextField
                        disabled
                        value={selectedUser?.user?.companyName}
                        fullWidth
                        label="Company Name"
                        size="small"
                        variant="outlined"
                    ...
                    <div className="form-controller-input-duo form-controller">
                      ...
                      <TextField
                        disabled
                        value={selectedUser?.company?.noOfEmployees}
                        size="small"
                        fullWidth
                    ...
                    <div className="form-controller-input form-controller">
                      <TextField
                        disabled
                        value={selectedUser?.company?.supplyAbility}
                        size="small"
                        fullWidth
    ...
    <div className="UsersMerchant-Table">
      ...
      <DataGrid
        components={{
          ...
          NoRowsOverlay: () => <Overlay label="Merchants" />,
        }}
