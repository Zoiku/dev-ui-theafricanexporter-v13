  ...
  return (
    <div className={timeoutReminder ? "SessionTimeoutContainer" : "hide"}>
      <div className="session-timeout">
        ...
        <div>
          You will be logged out in 5 minutes, please{" "}
          <span className="highlight-text-color"> re-login</span> to continue.
        </div>
      </div>
      <div>
        <MuiButton label="Logout" onClick={handleLogout} buttonType="101" />
      </div>
    </div>
  );
};
