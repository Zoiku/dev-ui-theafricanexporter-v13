...
const Orders = () => {
            ...
            <div className="requests-sections-body">
                <div className="orders-confirmation-sections-container">
                            ...
                            <FormControl>
                                ...
                                >
                                    <div className="radio-group-controller">
                                        ...
                                        />
                                        <NavLink target="_blank" rel="noopener noreferrer" style={navLinkStyle} to="/about/#payment-options-cash-against-document">Cash against documents (10%) Escrow deposit required</NavLink>
                                    </div>
                                    ...
                                    <div className="radio-group-controller">
                                        ...
                                        />
                                        <NavLink target="_blank" rel="noopener noreferrer" style={navLinkStyle} to="/about/#payment-options-letter-of-credit">Letter of credit</NavLink>
                                    </div>
                                    ...
                                    <div className="radio-group-controller">
                                        <Radio
                                            ...
                                            value="Bank transfer"
                                        />
                                        <NavLink target="_blank" rel="noopener noreferrer" style={navLinkStyle} to="/about/#payment-options-cash-bank-transfer">Bank transfer</NavLink>
                                    </div>
                                </RadioGroup>
                            </FormControl>
                        </div>
                    ...
                    <section>
                        ...
                        <div>
                            <TextField required sx={{ background: "white" }} multiline rows={3} fullWidth onChange={handleChange} type="text" name="shippingAddress" variant="outlined" />
                        </div>
                    </section>
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const buyerService = new BuyerService();
            try {
                const { data, errors } = await buyerService.getOrders(abortController.signal);
                if (errors.length === 0) {
                    const filteredData = data.data.data;
                    Promise.all(filteredData.map(async (order, index) => {
                        order.id = order._id;
                        order.index = index + 1;
                ...
                >
                    ...
                    <DialogContent>
                        <DialogContentText id="alert-dialog-slide-description">
                            Do you agree to confirm this order?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                        <GenericSecondary variant="text" onClick={handleCloseDialogConfirm}>Disagree</GenericSecondary>
                        <GenericPrimaryButton variant="contained" loading={state.requestState.loading} onClick={handleConfirm}>Agree</GenericPrimaryButton>
                    </DialogActions>
                </Dialog>
            </div>
                ...
                >
                    <Box sx={inAppStandard}>
                        <div className="modal-title-container">
                            ...
                            <div><CloseRoundedIcon onClick={toggleDrawerConfirm(false)} /></div>
                        </div>
