...
const NOTE_CIF = () => {
  return (
    <div>
      <div>
        <strong className="bold-note">Price per Container</strong>: CBM x Price
        per CBM
      </div>
      <div>
        <strong className="bold-note">Total Price</strong>: Price per Container
        x Quantity
      </div>
      <div>
        <strong className="bold-note">Insurance</strong>: 0.25% of Cargo value
        (Total Price)
      </div>
      <div>
        <strong className="bold-note">Total Freight</strong>: Freight rate x
        Quantity
      </div>
      <div>
        <strong className="bold-note">Total Amount</strong>: Total Price +
        Insurance + Total Freight
      </div>
    </div>
  );
};
...
const NOTE_CFR = () => {
  return (
    <div>
      ...
      <div>
        <strong className="bold-note">Total Amount</strong>: Total Price + Total
        Freight
      </div>
    </div>
  );
