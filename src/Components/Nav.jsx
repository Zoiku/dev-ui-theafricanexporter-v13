...
const Nav = ({ session }) => {
  ...
  return (
    <div
      className={
        location.pathname.substring(1) === "legal" ? "Nav no-sticky-Nav" : "Nav"
      }
    >
        ...
        {session.isLogged ? (
          ...
          >
            ...
            <NavLink
              ...
              className="hamburger-menu-links"
              style={defaultNavStyle}
              to={ROLE_PATH[session.user.role]}
            >
              <span>Dashboard</span>
            </NavLink>
          ...
          {session.isLogged ? (
            <>
              <li className="nav-links">
                <NavLink
                  style={defaultNavStyle}
                  to={`${toLowerCase(session.user.role)}/dashboard`}
                >
                  Dashboard
                </NavLink>
              </li>
            ...
            <>
              <li className="nav-links">
                <NavLink style={defaultNavStyle} to="/merchant/register">
                  Become a Merchant
                </NavLink>
              </li>
              <li className="nav-links">
                <NavLink style={defaultNavStyle} to="/buyer/register">
                  Sign Up
                </NavLink>
              </li>
              <li className="nav-links">
                <NavLink style={defaultNavStyle} to="/login">
                  Login
                </NavLink>
              </li>
            </>
